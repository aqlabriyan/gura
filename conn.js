...
"fileName": `Ryan-dev ${ngazap(prefix)}`,
...
var teks1 = `\n\nNomor : @${sender.split("@")[0]}\nPesan : ${q}`
var teks2 = `\n\nSucces send to owner`
var bg_lexxy = '6289687033380@s.whatsapp.net'
conn.sendMessage(bg_lexxy, {text: teks + teks1, mentions:[sender]}, {quoted:msg})
conn.sendMessage(from, {text: teks + teks2 + teks1, mentions:[sender]}, {quoted:msg})
}
break
...
axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=aqlabriyan@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
.then(response => {     
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Ryan-dev' })
}
console.log(feta)
}
break
...
if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/aqlabriyan/(repo)')
var linknya = q
...
.then(data => {
var opt = { packname: 'Bot', author: 'Ryan-dev' }
